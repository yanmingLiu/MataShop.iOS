...
#import "MSHotTopicCVCell.h"

@interface MSHotTopicCVCell ()
/// UI
...
@implementation MSHotTopicCVCell
...
+(instancetype)cellWithCollectionView:(nonnull UICollectionView *)collectionView
    ...
    MSHotTopicCVCell *cell = (MSHotTopicCVCell *)[collectionView collectionViewCellClass:MSHotTopicCVCell.class forIndexPath:indexPath];
    if (!cell) {
        [collectionView registerCollectionViewCellClass:MSHotTopicCVCell.class];
        cell = (MSHotTopicCVCell *)[collectionView collectionViewCellClass:MSHotTopicCVCell.class forIndexPath:indexPath];
    }
...
-(void)richElementsInCellWithModel:(UIViewModel *_Nullable)model{
    ...
    self.dataMutArr = self.viewModel.data;
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return [MSForHotTopicCVCell cellSizeWithModel:nil];
}
/// 定义的是元素垂直之间的间距
