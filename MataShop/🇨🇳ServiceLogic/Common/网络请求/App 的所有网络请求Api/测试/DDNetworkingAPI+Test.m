//
//  DDNetworkingAPI+Test.m
//  Casino
//
//  Created by Jobs on 2021/12/14.
//

#import "DDNetworkingAPI+Test.h"

@implementation DDNetworkingAPI (Test)
#pragma mark —— 测试
/// 批量发送分润MQ
...
//        request.url = [request.server stringByAppendingString:self.testSendMqGET.url];
//
...
//        request.timeoutInterval = 5;//默认30 //优先级 高于 公共配置,不影响其他请求设置
...
//
//        request.server = self.BaseUrl;
//        request.url = [request.server stringByAppendingString:self.testSendMsgToTelegramBotGET.url];
//        
//        NSLog(@"request.URLString = %@",request.url);
//        
//        request.methodType = ZBMethodTypeGET;//默认为GET
