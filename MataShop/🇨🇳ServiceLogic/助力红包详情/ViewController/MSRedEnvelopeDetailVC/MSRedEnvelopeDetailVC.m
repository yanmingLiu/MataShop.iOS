//
//  MSRedEnvelopeDetailVC.m
//  MataShop
//
//  Created by Jobs Hi on 9/18/23.
//

#import "MSRedEnvelopeDetailVC.h"

@interface MSRedEnvelopeDetailVC ()
/// UI
...
@implementation MSRedEnvelopeDetailVC
...
-(void)loadView{
    ...
    self.viewModel.textModel.text = Internationalization(@"助力红包详情");
...
-(JXCategoryTitleView *)categoryView{
    if (!_categoryView) {
        ...
        _categoryView.backgroundColor = RGB_SAMECOLOR(245);
...
-(NSMutableArray<UIViewController *> *)childVCMutArr{
    if (!_childVCMutArr) {
        ...
        [_childVCMutArr addObject:MSIncomeVC.new];/// 收入
        [_childVCMutArr addObject:MSDisburseVC.new];/// 支出
...
-(NSMutableArray<NSString *> *)titleMutArr{
    if (!_titleMutArr) {
        ...
        [_titleMutArr addObject:Internationalization(@"收入")];
