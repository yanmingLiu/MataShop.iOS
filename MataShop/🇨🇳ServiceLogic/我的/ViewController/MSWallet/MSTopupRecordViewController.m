//
//  MSTopupRecordViewController.m
//  MataShop
//
//  Created by Mac on 2023/10/24.
//

#import "MSTopupRecordViewController.h"
#import "MSTopupRecordModel.h"
#import "MSTopupRecordCell.h"
@interface MSTopupRecordViewController ()
/// UI
@property(nonatomic,strong)UICollectionViewFlowLayout *layout;
@property(nonatomic,strong)UICollectionView *collectionView;
/// Data
@property(nonatomic,strong)NSMutableArray <MSTopupRecordModel *>*dataMutArr;

@end

@implementation MSTopupRecordViewController
...
- (nonnull __kindof UICollectionViewCell *)collectionView:(nonnull UICollectionView *)collectionView
    ...
    MSTopupRecordCell *cell = [MSTopupRecordCell cellWithCollectionView:collectionView forIndexPath:indexPath];
...
- (CGSize)collectionView:(UICollectionView *)collectionView
  ...
  sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    return [MSTopupRecordCell cellSizeWithModel:nil];
}
/// 定义的是元素垂直之间的间距
...
-(NSMutableArray<MSTopupRecordModel *> *)dataMutArr{
    if (!_dataMutArr) {
        _dataMutArr = NSMutableArray.array;
        {
            MSTopupRecordModel *model = MSTopupRecordModel.new;
            model.title = Internationalization(@"提现");
            model.money = 1.2;
            model.type = @"银行卡";
            model.orderState = Internationalization(@"充值成功");
            model.orderID = @"5453553";
