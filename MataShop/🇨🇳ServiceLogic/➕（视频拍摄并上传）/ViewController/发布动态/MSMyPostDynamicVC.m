...
#import "MSMyPostDynamicVC.h"

@interface MSMyPostDynamicVC (){
...
@property(nonatomic,strong)UITextModel *myPostDynamicTextModel;

@end

@implementation MSMyPostDynamicVC
...
-(void)loadView{
    ...
    self.viewModel.textModel.text = Internationalization(@"发布动态");
...
-(JobsTextView *)textView{
    if (!_textView) {
        ...
        [_textView richElementsInViewWithModel:self.myPostDynamicTextModel];
        @jobs_weakify(self)
...
-(UITextModel *)myPostDynamicTextModel{
    if(!_myPostDynamicTextModel){
        _myPostDynamicTextModel = UITextModel.new;
        _myPostDynamicTextModel.text = self.inputDataHistoryString;
        _myPostDynamicTextModel.textCor = JobsBlackColor;
        _myPostDynamicTextModel.placeholder = Internationalization(@"说点什么吧~~~");
        _myPostDynamicTextModel.placeholderColor = RGB_SAMECOLOR(173);
        _myPostDynamicTextModel.font = UIFontWeightRegularSize(14);
        _myPostDynamicTextModel.maxWordCount = 300;
    }return _myPostDynamicTextModel;
}
